(function() {
	...
	// Icons: icons04.
		$('#icons04 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
				alert("Discord: Azzy#4227");
			}
		);
		
		$('#icons04 > li:nth-child(3) > a').addEventListener(
			'click',
			function(event) { 
				alert("Minecraft: Azzy___");
			}
		);
		
		$('#icons04 > li:nth-child(5) > a').addEventListener(
			'click',
			function(event) { 
				alert("0x12e6f12681B29866A3394bAE50df44c1202214AC");
			}
		);
